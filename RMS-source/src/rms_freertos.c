...
// Microros includes
#include "microros.h"
#include "rms-freertos.h"

// f429 usart include 
#include <usart.h>

// General standard c libaray includes
#include <stdbool.h>
#include <stdio.h>
#include <unistd.h>
...
void MicroRosFunc()
{
  ...
  // Create publisher
  rclc_publisher_init_default(&publisher, &node, ROSIDL_GET_MSG_TYPE_SUPPORT(std_msgs, msg, String), "/batStats_publisher");
